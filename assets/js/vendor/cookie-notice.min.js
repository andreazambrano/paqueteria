            ...
            if ("undefined" != typeof document) {
                ...
                for (var r = document.cookie ? document.cookie.split("; ") : [], s = /(%[0-9A-Z]{2})+/g, d = 0; d < r.length; d++) {
                    ...
                    try {
                        ...
                        if (m = p.read ? p.read(m, u) : p(m, u) || m.replace(s, decodeURIComponent),
                        this.json)
                            try {
                                m = JSON.parse(m)
                            } catch (e) {}
...
function gdprCookieNotice(c) {
    ...
    function o() {
        ...
        function() {
            ...
            e.addEventListener("click", function() {
                return document.documentElement.classList.remove(a + "-show-modal"),
                !1
            }),
            o.addEventListener("click", function(e) {
                e.preventDefault(),
            ...
            for (var i = 0; i < t.length; i++)
                t[i].addEventListener("click", function() {
                    return this.parentNode.parentNode.classList.toggle("open"),
                    !1
                });
        ...
        u && (document.getElementById(a + "-cookie_performance").checked = u.performance,
    ...
    function h() {
        o(),
        document.documentElement.classList.add(a + "-show-modal")
    }
    u ? (f(u),
    document.dispatchEvent(p)) : (g(),
    c.implicit && window.addEventListener("scroll", function e() {
        var o, t, n, i, c;
